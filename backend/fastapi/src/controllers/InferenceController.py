...
class InferenceController:
    ...
    def __init__(self, model: DecoderService, decoder: DecoderService, inferenceService: InferenceService):
        self.model = model
    ...
    async def inference(self, file: UploadFile):
        ...
        return self.inferenceService.detection_qr_collision_merge(
