...
class PromptPayService:
    ...
    def generate_promptpay_qr(self, phone_number, amount) -> Image.Image:   
        # qr_string = self.text_qr(account=phone_number,money=str(amount))
        ...
        return qrcode.to_image(qrcode.generate_payload(phone_number, amount))
